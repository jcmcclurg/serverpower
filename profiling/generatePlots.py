...
for experiment in dates.keys():
	...
	for i in serverNums:
		...
		for j in range(setpoints.shape[0]-1):
			...
			r = reject_outliers(powerData[segment,i][20:] - s + s[-1],3)
			power.append(r)
	...
	plt.savefig(currentExpDir+'/'+experiment+'.pdf')
	print "Saved to "+currentExpDir+"/"+experiment+".pdf"
