...
tail -f -q freq frames1 | $calcSetpoint -d 1 -M 34 -m 18 -B 3000 -o $logPath/calcSet1Data.csv > setpoint1 & 
tail -f -q freq frames2 | $calcSetpoint -d 1 -M 34 -m 18 -B 3000 -o $logPath/calcSet2Data.csv > setpoint2 & 
sudo $power_gadget -e 150 > power &
