...
# With tee and stress
(sudo $powerGadgetCmd -e 150 & pgid2=$!; stress -c 4 & playbackid=$!; tee; sudo kill -s SIGINT $pgid2 $playbackid; echo "q") | ($dir/../integralController -s 34 -n 1200000 -x 2500000 -t 130000 -k 0 -d 0 -u 10; sleep 1; echo "q") | sudo $dir/../../cpufreq/cpufreq.sh >> $me.$d.output 2>> $me.$d.output
