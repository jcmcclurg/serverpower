...
cat < toCalcSetpoint1 | $calcSetpoint -d 1 -M 34 -m 18 -B 3000 -o $logPath/calcSet1Data.csv | tee > toIController1 & 
cat < toCalcSetpoint2 | $calcSetpoint -d 1 -M 34 -m 18 -B 3000 -o $logPath/calcSet2Data.csv | tee > toIController2 & 
